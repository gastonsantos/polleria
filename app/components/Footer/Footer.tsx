...
const products: ProductType[] = [
    {
        id: 1,
        section: "Companía",
        link: ['Nosotros', 'Pedidos'],
    },
    {
        id: 2,
        section: "Contacto",
        link: ['Tel: 1(232)233-23', 'Dirección: ']
    }
    ,
    {
        id: 3,
        section: "Más",
        link: ['Recetas', 'Productos', 'Comida', 'Soporte']
    }
]
        ...
        <div className="mx-auto max-w-2xl pt-24 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="my-12 grid grid-cols-1 gap-y-10 sm:grid-cols-6 lg:grid-cols-12">
                ...
                <div className='sm:col-span-6 lg:col-span-5'>
                    ...
                    <h3 className='text-textbl text-xs font-medium mt-5 mb-4 lg:mb-16'> Calidad y buen sabor en tu mesa <br /> con mas de 40 años en el rubro.</h3>
            ...
            <div className='py-10 md:flex items-center justify-between border-t border-t-bordertop'>
                <h4 className='text-darkgrey text-sm text-center md:text-start font-normal'>@2024 - La Polleria. All Rights Reserved by <Link href="" target="_blank"> Vivalafrance</Link></h4>
